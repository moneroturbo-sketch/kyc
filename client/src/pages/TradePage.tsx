      ...
      <div className="max-w-2xl mx-auto space-y-4 sm:space-y-6 px-2 sm:px-4">
        ...
        <Card className="bg-gray-900/50 border-gray-800">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="p-4 bg-purple-900/30 dark:bg-purple-900/20 border border-purple-700 dark:border-purple-600 rounded-lg flex items-start gap-3">
              <Shield className="h-5 w-5 text-purple-400 dark:text-purple-300 mt-0.5" />
              <div>
